...
(
	SELECT  aid
	FROM `nbcu-ds-sandbox-a-001.wes_crm_sandbox.Q42022_Holdout2`
) ho
ON l.aid = ho.aid
--retrieve the rest of the global hold out that doesnt fit holdout definition. exclude these usersFROM the analysis
LEFT JOIN
(
